...
int main(int argc, char **argv) {
    ...
    string test_string = u8"日本福島核災之後，法國開始反思核電，現在超過6成人支持逐步廢核。總統歐蘭德已經決定，在2025年之前，核能佔總發電產出佔比，要從目前的75％降低到50％。法國因為過去蓋太多反應爐，產能已經過剩，有時候還得在週末關掉幾間核電廠，因為不需要這麼多電，現在我們需要的不是量，而是用電彈性。此外，能源消耗成長的時代已經過去了。RTE（法國電網公司）的報告指出，法國的耗能長期不會再成長，甚至還可能衰退。核電的安全和投資金額息息相關。過去10年EDF（法國電力集團）為了節省成本，在設備維修上投資不足，運作效率也比其他國家低。法國國會估算出確保核電安全所需經費，發現EDF的維修費用將會倍增。在未來10年內，法國每個反應爐需要花上10億至40億歐元，才能符合安全標準。如果把成本轉嫁到法國民眾身上，電費會上漲至少3成。我相信在未來，法國有很多核電廠會跟美國一樣，因為不敷成本而提早關閉。科技通常有個學習曲線，隨著時間系統建置成本會愈來愈低，太陽光電、風電皆是如此。例如德國太陽能發電，每千瓦的建置成本在7年內降低了75％。但核能卻反其道而行，愈來愈貴。幾個原因：安全維護的成本隨著時間增加，以及環境運動者的反彈聲浪，大幅拖慢核電廠興建進度，其他還包括技術人員不足，或是基礎原物料，例如銅的價格大幅上漲，讓核電成本幾乎倍增。我其實很擔心EDF被高昂的維修成本壓垮而破產，因為他們已經負債350億歐元，如果要提升所有反應爐安全標準，一定得大幅漲電價。";
